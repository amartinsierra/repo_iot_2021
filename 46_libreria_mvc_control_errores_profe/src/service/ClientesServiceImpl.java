...
class ClientesServiceImpl implements ClientesService {
	...
	@Override
	public Cliente validarCliente(String user, String password) throws ErrorConexionException{
		Cliente c=null;
	...
	@Override
	public boolean registrarCliente(Cliente cliente) throws ErrorConexionException{
